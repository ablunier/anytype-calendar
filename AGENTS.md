...
property — which onboarding and Settings save. `events` reads, for the month on screen, the
objects of the selected types whose dates fall in it, which the month screen draws. No
screen runs on mock data.
